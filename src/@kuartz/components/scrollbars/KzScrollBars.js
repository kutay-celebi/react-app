...
const KzScrollBars = React.forwardRef(function KzScrollBars(props, ref) {
    ref                      = ref || createRef();
...
export default connect(mapStateToProps, null, null, {forwardRef: true})(withRouterAndRef(KzScrollBars));
